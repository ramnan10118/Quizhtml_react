    ...
    <Card className={cn('w-full bg-gradient-to-br from-slate-50 to-slate-100 border-slate-200', className)}>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          {totalVotes > 0 && (
            <div className="text-sm text-slate-500 bg-slate-200 px-3 py-1 rounded-full">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isClickable && 'cursor-pointer hover:border-purple-300 hover:shadow-md',
                  isUserVote && 'border-purple-500 bg-purple-50 shadow-lg',
              ...
              >
                ...
                {showVoteCounts && (
                  <div
                    className="absolute inset-0 bg-gradient-to-r from-purple-100 to-purple-50 transition-all duration-500"
                ...
                <div className="relative flex items-center justify-between">
                  <div className="flex items-center space-x-3 flex-1">
                    <span
                      className={cn(
                        ...
                        isUserVote && 'bg-purple-200 text-purple-800',
                        isClickable && 'group-hover:bg-purple-200 group-hover:text-purple-800'
                      )}
                    >
                    ...
                    <span
                      className={cn(
                        ...
                        isUserVote && 'text-purple-800 font-semibold'
                      )}
                    >
                      {option}
                    </span>
                  ...
                  {isUserVote && (
                    <div className="ml-2">
                      <span className="text-purple-600 text-sm font-medium">✓ Your vote</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="flex items-center justify-center space-x-2 text-sm text-slate-500">
          <div
            className={cn(
              ...
              poll.isActive ? 'bg-green-500 animate-pulse' : 'bg-gray-400'
            )}
          />
          <span>
